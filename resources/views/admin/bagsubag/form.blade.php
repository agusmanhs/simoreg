                        ...
                        <form id="kt_modal_new_target_form" class="form" action="#">
                            ...
                            <div class="row g-9 mb-8">
                                <div class="col-md-4 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Kode Bagian / Sub Bagian</label>
                                    <input type="text" class="form-control" placeholder="Kode Bagian / Sub Bagian"
                                        name="kode" id="kode" maxlength="20" value="{{ $data->kode ?? '' }}" />
                                </div>
                                <div class="col-md-8 fv-row">
                                    <label class="fs-6 fw-semibold mb-2">Nama Bagian / Sub Bagian</label>
                                    <input type="text" class="form-control" placeholder="Nama Bagian / Sub Bagian"
