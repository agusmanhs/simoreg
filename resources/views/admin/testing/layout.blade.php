...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true"
    ...
    {{-- <script src="{{ asset('/') }}themes/dist/assets/js/custom/apps/ecommerce/customers/listing/listing.js"></script> --}}
    <script>
        "use strict";
        var KTCustomersList = function() {
                    ...
                    o.forEach((t => {
                        ...
                        Swal.fire({
                            ...
                            n.value ? Swal.fire({
                                ...
                                o.forEach((e => {
                                    e.checked && t.row($(e.closest(
                                            "tbody tr"))).remove()
                                        .draw()
                                }));
                                e.querySelectorAll('[type="checkbox"]')[0]
                                    .checked = !1
            ...
            const c = () => {
                ...
                c.forEach((t => {
                    t.checked && (r = !0, l++)
                })), r ? (n.innerHTML = l, t.classList.add("d-none"), o.classList.remove("d-none")) : (t
                    .classList.remove("d-none"), o.classList.add("d-none"))
            };
            return {
                init: function() {
                    (e = document.querySelector("#kt_customers_table")) && (e.querySelectorAll("tbody tr").forEach((
                            t => {
                            ...
                            n(), o(), c()
                        })), n(), document.querySelector('[data-kt-customer-table-filter="search"]')
...
KTUtil.onDOMContentLoaded(function () {
    ...
    <script src="{{ asset('/') }}themes/dist/assets/js/custom/apps/ecommerce/customers/listing/add.js"></script>
    {{-- <script src="{{ asset('/') }}themes/dist/assets/js/custom/apps/ecommerce/customers/listing/export.js"></script> --}}
